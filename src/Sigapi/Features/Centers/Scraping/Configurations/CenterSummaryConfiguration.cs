...
[UsedImplicitly]
internal sealed partial class CenterSummaryConfiguration : IScrapingModelConfiguration<CenterSummary>
{
    public void Configure(ScrapingModelBuilder<CenterSummary> builder)
    {
